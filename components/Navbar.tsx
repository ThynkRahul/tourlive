...
const NavBar: React.FC<{ locale: string }> = ({ locale }) => {
  ...
  // prefix auto calc — EN has no prefix, others do
                ...
                <Link key={index} href={link.href} passHref>
                  <button
                    ...
                    className={`btn btn-ghost btn-sm rounded-btn ${
                      activePage === link.href ? "text-[#6E9753] text-[16px]" : "text-[#025C7A] text-[16px]"
                    }`}
                  >
                    {link.label}
                  </button>
              ...
              <Link href={`${prefix}/contact`} passHref>
                <button
                  className={`btn btn-ghost btn-sm text-[16px] rounded-btn ${
                    activePage === `${prefix}/contact` ? "text-[#6E9753]" : "text-[#025C7A]"
                  }`}
